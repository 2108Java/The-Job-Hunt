...
public class SavedJobsServicesTest extends TheJobHuntApplicationTests {
	...
	private static Jobs realJob = new Jobs(1,realUser, 7845868, "","","","","", "", "", false);
	private static Jobs fakeJob = new Jobs(-1,fakeUser, 7845868, "","","","","", "", "", false);
	private static Jobs secondJob = new Jobs(1,secondUser, 7845868, "","","","","", "", "", false);
