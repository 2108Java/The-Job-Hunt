...
public class TestUserServices extends TheJobHuntApplicationTests{
	...
	public void testInsertUser() {
		...
		when(userDao.save(fakeUser)).thenReturn(fakeUser);
		assertFalse(userServices.insertUser(fakeUser));
		assertTrue(userServices.insertUser(realUser));
		assertTrue(userServices.insertUser(secondUser));
	}
